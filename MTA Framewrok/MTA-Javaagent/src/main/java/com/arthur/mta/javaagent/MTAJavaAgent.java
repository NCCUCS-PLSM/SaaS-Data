...
import com.arthur.mta.core.enhance.MTAClassFileTransformer;

public class MTAJavaAgent {
	  ...
	  //static final Logger logger = LoggerFactory.getLogger(MyJavaAgent.class);
	    ...
	    public static void premain(String args, Instrumentation inst) throws Exception {
	        ...
	        instrumentation.addTransformer(new MTAClassFileTransformer());
	    }
