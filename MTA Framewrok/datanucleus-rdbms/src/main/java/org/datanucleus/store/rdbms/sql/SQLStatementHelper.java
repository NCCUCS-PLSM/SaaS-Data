...
public class SQLStatementHelper
{
    ...
    public static Object getValueForPrimaryKeyIndexOfObjectUsingReflection(Object value, int index, 
            AbstractClassMetaData cmd, MappedStoreManager storeMgr, ClassLoaderResolver clr)
    {
        if (cmd.getIdentityType() == IdentityType.DATASTORE)
        {
            ...
            JavaTypeMapping mapping)
    {
        ...
        if (table instanceof SecondaryDatastoreClass || table instanceof JoinTable)
        {
            ...
            if (mapping.getDatastoreContainer() != null)
            {
                ...
                SQLTable mappingSqlTbl = stmt.getTable(mapping.getDatastoreContainer(), sqlTbl.getGroupName());
    ...
    public static SQLTable addJoinForOneToOneRelation(SQLStatement stmt,
            ...
            JavaTypeMapping targetMapping, DatastoreContainerObject targetTable, String targetAlias,
