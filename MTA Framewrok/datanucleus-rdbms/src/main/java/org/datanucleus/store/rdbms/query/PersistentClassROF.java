...
public final class PersistentClassROF implements ResultObjectFactory
{
    ...
    public Object getObject(final ExecutionContext ec, final Object rs)
    {
        ...
        //todo arthur add here
        if(UTbServiceHelper.isMTAAnnoated(obj.getClass().getAnnotations())){
        	 obj = UTbServiceHelper.doCustomField(obj, (ResultSet)rs, mappingDefinition);
        }
       //end here
     ...
     */
    public static Object getIdentityForResultSetRow(RDBMSStoreManager storeMgr, final Object resultSet, 
     ...
     * @return The Object
     */
    private Object getObjectForDatastoreId(final ExecutionContext ec, final Object resultSet, 
            final StatementClassMapping mappingDefinition, final int[] fieldNumbers,
