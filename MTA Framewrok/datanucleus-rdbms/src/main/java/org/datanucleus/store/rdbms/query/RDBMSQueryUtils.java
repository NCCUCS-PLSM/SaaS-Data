...
public class RDBMSQueryUtils extends QueryUtils
{
    ...
    {
        String rsTypeString = 
            query.getExecutionContext().getNucleusContext().getPersistenceConfiguration().getStringProperty(JDOQLQuery.EXTENSION_RDBMS_RESULTSET_TYPE);
        Object rsTypeExt = query.getExtension(JDOQLQuery.EXTENSION_RDBMS_RESULTSET_TYPE);
        if (rsTypeExt != null)
        {
    ...
    public static String getResultSetConcurrencyForQuery(Query query)
    {
        String rsConcurrencyString = 
            query.getExecutionContext().getNucleusContext().getPersistenceConfiguration().getStringProperty(JDOQLQuery.EXTENSION_RDBMS_RESULTSET_CONCURRENCY);
        Object rsConcurrencyExt = query.getExtension(JDOQLQuery.EXTENSION_RDBMS_RESULTSET_CONCURRENCY);
