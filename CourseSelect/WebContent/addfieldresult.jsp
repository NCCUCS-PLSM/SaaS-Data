      ...
      <div class="span3">
        ...
        <div class="span9">
			...
			if(TenantName!=null)
			{
				...
				FieldType = new String(request.getParameter("fieldtype").getBytes("ISO-8859-1"));
				if(FieldType.contentEquals("char"))
				{
					FieldType = "char(50)";
				}

				String DefaultValue = new String(request.getParameter("defaultvalue").getBytes("ISO-8859-1"));
				if(DefaultValue.equals(""))
				{
					...
					{
						DefaultValue = Double.toString(0.0);
					}
					else
					{
						DefaultValue = "null";
				...
				String altersql = "ALTER TABLE CourseInfo add "+FieldName+" "+FieldType;
				...
				{
					updatesql = "UPDATE CourseInfo SET "+FieldName+" = "+DefaultValue;
				}
				else
				{
					updatesql = "UPDATE CourseInfo SET "+FieldName+" = '"+DefaultValue+"'";
