...
%>
      ...
      <div class="row-fluid">
       <div class="span3">
        ...
        <div class="span9">
		  ...
		  <form class="form-horizontal" action = searchcourseresult.jsp?TenantName=<%=TenantName%> method=post name = form30>
  <div class="control-group">
    <label class="control-label" for="inputEmail">CourseId</label>
    <div class="controls">
      <input type="text" id="CourseId" placeholder="CourseId" name = CourseId>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputEmail">CourseName</label>
    <div class="controls">
      <input type="text" id="CourseName" placeholder="CourseName" name = CourseName>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputPassword">Instructors</label>
    <div class="controls">
      <input type="text" id="inputTeacherName" placeholder="TeacherName" name = TeacherName>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputEmail">Days</label>
    <div class="controls">
      <select class = span6 name = "Days"" >
		<option selected="selected">Days
  ...
  <div class="control-group">
    <div class="controls">
      ...
      <button type = submit class="btn" onclick = "submitform3()">Search Course</button>
