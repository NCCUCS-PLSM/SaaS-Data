			...
			while(rs.next())
        	  {
                ...
                out.print("<h1>"+rs.getObject("CourseName")+" 已經在 "+rs.getObject("SelectDate").toString().replace(".0", "")+" 加入選課清單中</h1>");
