...
String PageName = "addproduct.jsp";
      ...
      <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="addproduct.jsp">Add Course information</a></li>
        ...
        <div class="span9">
			...
			if(TenantName!=null)
			{
	            ...
	            ResultSet rs = (ResultSet) stmt.executeQuery("SELECT Count(CourseId) FROM CourseInfo");
				...
				newCourseId = TenantName+newItemId;
	            stmt.close();
	            out.print("<h2>Add Course Information</h2>");
	            ...
	            //out.print("<form class="form-horizontal" action = te.jsp method=post name = addproductform>")
	            out.print("<form class= 'form-horizontal' action = addproductresult.jsp enctype= multipart/form-data method=post name = addproductform id = addproductform>");

	            while(schemas.next())
				{
	            	if(schemas.getString("COLUMN_NAME").equals("CourseId"))
	            	{
	            		out.print("<input type = hidden name = CourseId value = "+newCourseId+">");
	            	}
	            	else if(schemas.getString("COLUMN_NAME").equals("IsClosed"))
	            	{
	            		out.print("<input type = hidden name = IsClosed value = 0>");
	            	}
					else
					{
	            ...
	            //out.print("<br>Picture:<input type = file name = file1 ></br>");



	            out.print("<div class= control-group >");
	            out.print("<div class= controls >");
	            out.print("<button type = submit class= btn  onclick = redirect() >Add Course Information Now !!</button>");
	            out.print("</div>");
	            out.print("</div>");
	            out.print("</form>");
