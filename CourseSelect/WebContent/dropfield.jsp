      ...
      <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="dropfield.jsp">Remove Customized Column</a></li>
        ...
        <div class="span9">
          ...
          if(TenantName!=null)
		  {
        	  out.print("<h2>Remove Customized Column</h2>");
        	  out.print("<form class=form-horizontal action = dropfieldresult.jsp method=post name = form4>");
              ...
              out.print("<div class=control-group>");
          	  ...
          	  out.print("<button type = submit class= btn onclick = submitform4()>Remove Customized Column >></button></form></div>");
		  }
		  else
		  {
