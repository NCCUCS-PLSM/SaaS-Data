...
//String PageName = "updatefield.jsp";
      ...
      <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="updatefield.jsp">Update Customized Column</a></li>
        ...
        <div class="span9">
          ...
          if(TenantName!=null)
		  {
        	  out.print("<h2>Update Customized Column</h2>");
        	  out.print("<form class=form-horizontal action = updatefieldresult.jsp method=post name = form19>");
              out.print("<div class=control-group>");
              out.print("<label class=control-label for=inputEmail>Column Name</label>");
         	  out.print("<div class=controls>");
        	  out.print("<input type=text id=inputEmail placeholder='Column Name' name = fieldname>");
          	  out.print("</div>");
              out.print("</div>");
              ...
              out.print("<div class=control-group>");
           	  out.print("<label class=control-label for=inputPassword>New Column Name</label>");
           	  out.print("<div class=controls>");
           	  out.print("<input type=text id=inputPassword placeholder='New Column Name' name = newfieldname>");
              out.print("</div>");
         	  out.print("</div>");
              out.print("<div class=control-group>");
          	  out.print("<div class=controls>");
          	  ...
          	  out.print("<button type = submit class= btn onclick = submitform19()>Update Customized Column >></button></form></div>");
		  }
		  else
		  {
