      ...
      <div class="span3">
          <div class="well sidebar-nav">
            ...
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="removecourse.jsp?TenantName=<%=TenantName%>">Remove Selected Course</a></li>
            </ul>
          </div><!--/.well -->
        </div><!--/span-->
...
else
{
	...
	//out.print(TenantName);
	out.print("<form method=post action = 'removecourseresult.jsp?TenantName="+TenantName+"' name = form21 id = form21>");
    ...
    while(rs.next())
	{
		...
		String value = rs.getObject("SelectId").toString();

		out.print("<td>");
		out.print("<input type= checkbox name = checkcourse value= "+value+">");
		...
		for (int i=1; i<numColumns+1; i++)
		{
				...
				//out.println("</td>");
				//out.print(rs.getObject("SelectId")+" "+rs.getObject("Priority"));
...
out.print("<p><input type = button value = 'Remove Course Now >>' onclick = redirect('"+TenantName+"') class = 'btn'></p>");
