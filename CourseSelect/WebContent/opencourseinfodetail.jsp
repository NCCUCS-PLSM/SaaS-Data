    ...
    <div class="container-fluid">
      ...
      <div class="span3">
        ...
        <div class="span9">
          ...
          <form action = IndexForTenant.jsp method=post name = form10 id = form10>
		  ...
		  <form>
			...
			if(TenantName!=null)
			{
	            ...
	            String updatesql = "UPDATE CourseInfo SET IsClosed = 0 WHERE CourseId = '"+CourseId+"'";
...
{
	//alert(name+" "+page);
	document.form10.TenantName.value=name;
	document.form10.NowPage.value=page;
	//alert(name);
	form10.submit();
	//alert(name);
