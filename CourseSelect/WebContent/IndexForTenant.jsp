...
<%
			...
			if(TenantName!=null)
			{
			  ...
			  sql = "SELECT CourseId, CourseName, Instructors FROM CourseInfo WHERE IsClosed = 0 LIMIT 6 OFFSET "+Integer.toString(OffsetValue);
					//out.print(sql);
...
{
	//alert(name+" "+page);
	document.form6.TenantName.value=name;
	document.form6.NowPage.value=page;
	//alert(name);
	form6.submit();
	//alert(name);
