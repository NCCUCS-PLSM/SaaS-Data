      ...
      <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="addfield.jsp">Add Customized Column </a></li>
        ...
        <div class="span9">
          ...
          if(TenantName!=null)
		  {
        	  ...
        	  out.print("<h2>Add Customized Column</h2>");
        	  out.print("<form class=form-horizontal action = addfieldresult.jsp method=post name = addfieldform>");
              out.print("<div class=control-group>");
              out.print("<label class=control-label for=inputEmail>New Column Name</label>");
         	  out.print("<div class=controls>");
        	  out.print("<input type=text id=inputEmail placeholder='New Column Name' name = fieldname>");
          	  out.print("</div>");
              out.print("</div>");

              out.print("<div class=control-group>");
           	  out.print("<label class=control-label for=inputPassword>New Column Type</label>");
           	  out.print("<div class=controls>");
           	  out.print("<select name = fieldtype >");

           	  out.print("<option value = 'char (50)''>char</option>");
           	  out.print("<option value = integer>integer</option>");
           	  out.print("<option value = double>double</option>");
          	  out.print("<option value = boolean>boolean</option>");
           	  out.print("<option value = date>date</option>");
           	  out.print("<option value = time>time</option>");
           	  out.print("</select>");

           	  //out.print("<input type=password id=inputPassword placeholder='New Column Type' name = 'New Column Type'>");
              out.print("</div>");
         	  out.print("</div>");


              out.print("<div class=control-group>");
           	  out.print("<label class=control-label for=inputPassword>Default Value</label>");
           	  out.print("<div class=controls>");
           	  out.print("<input type=text id=inputPassword placeholder='Default Value' name = defaultvalue>");
              out.print("</div>");
         	  out.print("</div>");
              out.print("<div class=control-group>");
          	  out.print("<div class=controls>");
          	  //out.print("<input name= PageName value= '' type= hidden >");

          	  out.print("<button type = submit class= btn onclick = submitaddfieldform()>Add Customized Column >></button></form></div>");
		  }
		  else
		  {
