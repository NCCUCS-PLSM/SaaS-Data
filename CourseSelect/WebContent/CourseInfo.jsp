    ...
    <div class="container-fluid">
      ...
      <div class="span3">
        ...
        <div class="span9">
		  ...
		  <form action = IndexForTenant.jsp method=post name = form6 id = form6>
			...
			while(rs.next())
        	  {
                ...
                for(int i = 1;i <= rs.getMetaData().getColumnCount();i++)
            	{
    				...
    				out.println("</td>");
    				out.println("</tr>");
              		/*out.print("<tr><th>"+rs.getMetaData().getColumnName(i)+"</th>");
          			out.print("<th>"+rs.getObject(rs.getMetaData().getColumnName(i))+"</th>");
          			out.print("</tr>");*/
              	  }
            	}
                ...
                out.print("<p><a href='updatecourseInfoDetail.jsp?CourseId="+rs.getObject("CourseId")+"' class = 'btn'>Update Course Information >></a><p><a href='closeiteminfodetail.jsp?CourseId="+rs.getObject("CourseId")+"' class = 'btn'>Close Course Information >></a><p><a href='viewstudentlist.jsp?CourseId="+rs.getObject("CourseId")+"' class = 'btn'>View Student List >></a></p>");
