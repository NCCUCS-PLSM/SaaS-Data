...
<div id="wrapper">
	...
	<div id="bottomwide">
		<div id="bottom">
			...
			<div class="tg">
					<div id="nav2"><jdoc:include type="modules" name="mainmenu" style="none" /></div>
					<?php $app = JFactory::getApplication(); $menu = $app->getMenu(); $lang = JFactory::getLanguage(); if ($menu->getActive() == $menu->getDefault($lang->getTag())) : ?><a href="http://goodhostingcompanies.com" target="_blank">Good Hosting Companies</a><?php endif; ?>
					<div id="right"><?php if ($this->params->get( 'footerdisable' )) : ?><?php echo ($footertext); ?><?php endif; ?> - <?php echo date('l \t\h\e jS');?></div>
			</div>		
