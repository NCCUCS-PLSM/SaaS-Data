...
<div id="wrapper">
	...
	<div id="bottomwide">
		...
		<?php if ($this->params->get( 'footerdisable' )) : ?><?php echo ($footertext); ?><?php endif; ?>. 
				<?php $app = JFactory::getApplication(); $menu = $app->getMenu(); $lang = JFactory::getLanguage(); if ($menu->getActive() == $menu->getDefault($lang->getTag())) : ?>By xs <a href="http://www.xswebdesign.com" target="_blank">web design</a>
				<?php endif; ?>
		</div>
	</div> 
</body>
